<template>
  <div>
   ...
   <el-breadcrumb-item :to="{path:'/addSingleClassPages'}">新增单节课</el-breadcrumb-item>
    </el-breadcrumb>
    </div>
    <!-- 单节课页面 -->
    ...
    <div class="single">
        ...
        <div class="banner-spared">
          ...
          >
            ...
            <div class="el-upload__text">将MP4格式的文件拖到此处，或<em>点击上传</em></div>
          </el-upload>
          <video :src="'http://172.168.11.229:9000' + this.videoUrl" style="width:360px;height:180px" controls v-else></video>
          </div>
        ...
        <div class="img-banner">
          ...
          >
            <i class="el-icon-upload"></i>
            <div class="el-upload__text">将视频封面图片拖到此处，或<em>点击上传</em></div>
          </el-upload>
          <img :src="'http://172.168.11.229:9000' + this.formList.course_cover_url" alt="" class="img-cover" v-else>
        </div>
        <!-- 下方文字描述区域 -->
        ...
        <div class="select-introduce select-public">
          <span class="point-public"></span>
          推荐位选择
          <el-select v-model="formList.posid" placeholder="请选择" class="el-select" clearable>
            <el-option
