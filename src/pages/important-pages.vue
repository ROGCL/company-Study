    ...
    <div class="bottom-area">
      ...
      <div class="show-area">
        ...
        >
          ...
          <el-table-column label="视频封面" width="126"> </el-table-column>
          ...
          <el-table-column prop="course_uv" sortable label="学习人数" width="98">
          </el-table-column>
          <el-table-column prop="course_pv" sortable label="学习人次" width="98">
          </el-table-column>
          <el-table-column prop="time_add" sortable label="新增时间" width="162">
          </el-table-column>
          <el-table-column prop="status" label="上架状态" width="100">
            <template slot-scope="scope">
              <div
                class="small-attitube1"
                v-if="listform[scope.$index].status == 0"
              ></div>
              <div
          ...
          <el-table-column prop="time_update" sortable label="修改时间" width="162">
          </el-table-column>
