        ...
        <div class="content">
            ...
            <el-form class="form" ref="addForm" :model="addForm" label-width="80px" :rules="addRules" v-if="stepActive=== 1">
                ...
                <el-form-item label="账户名" required prop="account_name" >
                    <!-- disabled v-loading="accountLoading" -->
                    <el-input v-model="addForm.account_name" @blur="fetchAccountName"></el-input>
                </el-form-item>
                <el-form-item label="收款户名" required prop="proceeds_user">
                    <el-input v-model="addForm.proceeds_user"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="onCreate" :disabled="savebtndisable" v-loading="addLoading">保存并下一步</el-button>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        async fetchAccountName(e) {
            ...
            let { system_create, account_id, origin, title,account_name } = this.addForm
