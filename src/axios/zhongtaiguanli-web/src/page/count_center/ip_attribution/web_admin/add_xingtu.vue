    ...
    <div class="content">
      ...
      >
        ...
        <el-form-item label="广告主ID" required prop="account_id">
          <el-input v-model="addForm.account_id" @blur="fetchAccountName" @change="changeAccoutId"></el-input>
        </el-form-item>
        <el-form-item label="账户名"  prop="account_name" v-if="accountInit">
          <el-input v-model="addForm.account_name" disabled v-loading="accountLoading"></el-input>
        </el-form-item>
        <el-form-item label="订单ID" required prop="ad_id" >
          <el-input v-model="addForm.ad_id"  @change="changeAdId"></el-input>
        </el-form-item>
        <el-form-item label="订单名称"  prop="ad_name">
...
export default {
  data() {
    return {
      ...
      addRules: {
        ...
        ad_id: [{ required: true, message: '请输入订单ID' }],
        account_name: [
  ...
  methods: {
    ...
    async fetchAccountName(e) {
      ...
      const data = await this.$http.post('Ip/getAccountName', {
        system_create,
        account_id,
        origin,
        title,
      ...
      this.addForm.ad_name = res.demand_name
