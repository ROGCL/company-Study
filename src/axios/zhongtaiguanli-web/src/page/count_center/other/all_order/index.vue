<template>
  <div>
    ...
    >
      ...
      <el-col :md="6" :lg="6" :sm="12">
        <el-form-item label="支付日期" prop="pay_time">
          <dataPicker
            :clearFlag="
      ...
      <el-col :md="6" :lg="6" :sm="12">
        <el-form-item label="激活日期" prop="activate_time">
          <dataPicker
            :clearFlag="
      ...
      <el-col :md="6" :sm="12">
        <el-form-item label="归因渠道" prop="origin">
          <!-- <SelectCustomize
            ...
            :data="originIds"
          /> -->
          <SelectChannel v-model="searchForm.origin"></SelectChannel>
        </el-form-item>
      </el-col>
      <el-col :md="6" :sm="12">
...
export default {
  ...
  methods: {
    ...
    async getReport() {
      ...
      const [err, res] = await this.$http.post("App/orderList", {
    ...
    async getVersion() {
      ...
      const [err, res] = await this.$http.post("App/versionChannel", {
        ...searchForm,
        appId: this.$route.query.appId,
      });
      if (err) {
    ...
    async getOrderKanban() {
      const { searchForm } = this;
      const [err, res] = await this.$http.post("App/orderKanban", {
        ...searchForm,
        appId: this.$route.query.appId,
      });
      if (err) {
    ...
    async getOrderScreening() {
      ...
      const { searchForm } = this;
      const [err, res] = await this.$http.post("App/orderScreening", {
        appId: this.$route.query.appId,
        ...searchForm,
      });
      if (err) {
    ...
    initFrom() {
      ...
      this.searchForm.is_pay = [];
      this.searchForm.uid = "";
      this.searchForm.ostr = "";
      this.searchForm.transcation_no = "";
      this.searchForm.app_version = [];
      this.searchForm.pay_way = [];
      this.searchForm.goods_title = [];
      this.searchForm.order_cate = "";
      this.searchForm.is_day = "";
      this.searchForm.is_first = [];
      this.searchForm.form_path = true;
