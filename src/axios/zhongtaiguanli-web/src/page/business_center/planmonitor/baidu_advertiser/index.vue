    ...
    >
      <template #table-option>
        <el-button
          type="primary"
          @click="
            $router.push('/business_center/planmonitor/baidu_advertiser/authorize')
          "
          >授权管理</el-button
        >
      </template>
      ...
      <template #option="scope">
        ...
        >
        <!-- <el-button type="text" class="mg-left" @click="changeTokenFlag(scope.row.id)">更改token</el-button> -->
      </template>
    </TableLayout>
