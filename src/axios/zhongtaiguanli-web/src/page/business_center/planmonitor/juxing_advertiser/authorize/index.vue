<template>
  <div class="home">
    <FilterLayout v-model="searchForm" @onSubmit="onSubmit">
      ...
      <el-col :md="6" :sm="12">
        <el-form-item label="聚星账户ID" prop="account_id">
          <el-input v-model="searchForm.account_id" placeholder="请输入聚星账户ID" />
        </el-form-item>
      </el-col>
    ...
    <el-dialog title="聚星账户开发者授权" :visible.sync="addVisible">
      <el-form ref="addForm" :model="addForm" label-width="150px" :rules="addRules">
        ...
        <el-form-item label="聚星账户ID" prop="account_id">
          <el-input v-model="addForm.account_id" placeholder="聚星账户ID" :disabled="edit" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      addRules: {
        ...
        account_id: [{ required: true, message: '请输入聚星账户ID' }],
      },
      edit: false,
    }
  },
