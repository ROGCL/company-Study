<template>
  <div class="home">
    <FilterLayout v-model="searchForm" @onSubmit="onSubmit">
      <el-col :md="6" :sm="12">
        <el-form-item label="广告主ID" prop="account_id" label-width="70px">
          <el-input
      ...
      <el-col :md="6" :sm="12">
        <el-form-item label="订单ID" prop="status" label-width="70px">
          <el-input v-model="searchForm.ad_id" placeholder="请输入订单ID" />
        </el-form-item>
      </el-col>
      <el-col :md="6" :sm="12">
        <el-form-item label="App名称" prop="app_id" label-width="70px">
          <!-- <SelectApp v-model="searchForm.app_id"></SelectApp> -->
          <SelectCustomize :value="searchForm.app_id" :data="apps" />
        </el-form-item>
      </el-col>
      <el-col :md="6" :sm="12">
        <el-form-item label="渠道号" prop="channel" label-width="100px">
    ...
    >
      <template #table-option>
        <el-button
          ...
          @click="
            $router.push(
              '/business_center/planmonitor/xingtu_advertiser/authorize'
            )
          "
          >授权管理</el-button
        >
...
export default {
  ...
  methods: {
    ...
    async editConfrim() {
      ...
      const [err, res] = await this.$http.post("Invest_Config/addSendDate", {
        id: this.editItemId,
